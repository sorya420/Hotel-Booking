...
//     setSearcheCities((prevSearchedCities) => {
...
//             <form onSubmit={onSearch} className="bg-white rounded-2xl p-6 mt-10 shadow-2xl">
...
//                   <input onChange={e => setDestinations(e.target.value)} value={destination}
//                     list="destinations"
