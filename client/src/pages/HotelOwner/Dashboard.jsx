  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashborad"
        subTitle="Monitor your room listing, tracks bookings and analyze revenue-all in one place. stay pdate with real-time insights to ensure smooth operations."
      />
      <div className="flex gap-4 my-8">
        ...
        <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
          ...
          <div className="flex flex-col sm:ml-4 font-medium">
            ...
            <p className="text-neutral-400">{currency} {dashboardData.totalRevenue}</p>
          </div>
        </div>
      </div>
      {/**Recent Bookings */}
